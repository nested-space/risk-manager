...
async def test_material_add_augment_yes_fills_smiles_and_aliases(
    ...
    await dispatcher.advance_prompt("")  # accept the pre-filled SMILES
...
async def test_ncrm_add_augment_uses_common_name_then_manual_display_name(
    ...
    await dispatcher.advance_prompt("true")  # interpret_chemically
    await dispatcher.advance_prompt("")  # accept pre-filled SMILES
